...
void loop(ros::NodeHandle pn, ros::NodeHandle n) {
    ...
    //ROS_INFO("%d %d %d %d %d %d", pwm_data[1].i, pwm_data[2].i, enc_data[0].i, enc_data[1].i, res1, res2);
    ...
    if(displayLoopInfo) {
      ROS_INFO("%d %d %d %d %d %d %d %d", cmd, pwm_data[1].i, pwm_data[2].i, enc_data[0].i, enc_data[1].i, res1, res2, res3);
    }
...
int main(int argc, char **argv){
    ...
    ROS_INFO("Starting base_mpu6050_node...");
    ...
    // SETUP OTHER
    //
    ros::Subscriber cmd_sub = n.subscribe("mcu_cmd", 100, cmdCallback);
    ...
    //I2Cdev::writeBytes(I2CADDR_STM32, MCU_CMD_RESET_ENCODER, 3, dataptr2);
